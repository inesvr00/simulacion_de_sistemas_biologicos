...
def plot_histograma_kerma_dosis(df, nombre, N=None, E_0=None, min=None, max=None):
    ...
    plt.grid(True)
    plt.savefig(f'/home/debian/dev/simulacion_de_sistemas_biologicos/out/plots/{nombre}.png')
...
def plot_kerma_y_dosis(df_dosis, df_kerma, N, E_0, min, max):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f'/home/debian/dev/simulacion_de_sistemas_biologicos/out/plotsdosis_kerma_fits.png')
    plt.show()